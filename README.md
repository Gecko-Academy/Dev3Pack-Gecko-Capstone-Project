...
That is the whole setup. There is nothing to install yet: the first project says what it
needs, and it needs no API key.

**Windows:** run these in **Git Bash** or WSL2, not PowerShell.

If you have SSH keys set up,
`git clone git@github.com:Gecko-Academy/Dev3Pack-Gecko-Capstone-Project.git my-capstone`
...
|---|---|---|---|
| Monday 28 | 11 — state and memory | | arrives Monday |
...
| Path | What is in it |
|---|---|
| `projects/` | one folder per day, each with its own README and its own check |
| `README.md` | this page |
